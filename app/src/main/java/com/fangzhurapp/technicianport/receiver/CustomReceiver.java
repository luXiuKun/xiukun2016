...
import com.fangzhurapp.technicianport.frag.WorkFragment;
...
public class CustomReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (JPushInterface.ACTION_REGISTRATION_ID.equals(intent.getAction())) {
             ...
             * 技师的通知
             */
        if (SpUtil.getString(context,"ident","").equals("js")){
    ...
    private void processCustomMessage(Context context) {
            ...
            Intent msgIntent = new Intent(WorkFragment.MESSAGE_RECEIVED_ACTION);
