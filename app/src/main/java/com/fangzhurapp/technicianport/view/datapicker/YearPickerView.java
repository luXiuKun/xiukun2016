...
import com.fangzhurapp.technicianport.view.datapicker.DatePickerDialog.OnDateChangedListener;
...
public class YearPickerView extends ListView implements OnItemClickListener, OnDateChangedListener {
    ...
    public YearPickerView(Context context, DatePickerController controller) {
        ...
        mViewSize = res.getDimensionPixelOffset(R.dimen.dd_dimen_550px);
        mChildSize = res.getDimensionPixelOffset(R.dimen.dd_dimen_125px);
