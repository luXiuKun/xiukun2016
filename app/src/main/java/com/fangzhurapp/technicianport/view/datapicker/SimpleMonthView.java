...
import com.fangzhurapp.technicianport.view.datapicker.SimpleMonthAdapter.CalendarDay;
...
public class SimpleMonthView extends View {
    ...
    public SimpleMonthView(Context context) {
        ...
        MONTH_HEADER_SIZE = res.getDimensionPixelOffset(R.dimen.dd_dimen_100px);
        DAY_SELECTED_CIRCLE_SIZE = res
                .getDimensionPixelSize(R.dimen.dd_dimen_32px);

        mRowHeight = (res.getDimensionPixelOffset(R.dimen.dd_dimen_540px)
